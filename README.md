...
[![Greenkeeper badge](https://badges.greenkeeper.io/Beatons/web-seasons-api.svg)](https://greenkeeper.io/)

A RESTful API generated by [generator-rest](https://github.com/diegohaz/generator-rest).

you can start using the restAPI after running these commands:

npm install
npm run dev

If you want to see the documentation for routes and different commands please run this command:
